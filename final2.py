...
class DogBreedRecognitionApp(ctk.CTk):
    ...
    def _create_ui(self):
        ...
        self.select_btn.pack(side="left", padx=30, pady=15)
        ...
        self.recognize_btn.pack(side="left", padx=30, pady=15)
        ...
        self.info_text.insert("0.0", "✅ 系统已就绪，请选择照片开始识别...")
